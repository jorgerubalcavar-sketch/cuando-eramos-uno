# Enlaces publicados - Video largo 1

## Cuando éramos uno - Antes de las estrellas
...
## Archivo TikTok extra - orden provisional
...
## Ruta narrativa usada en la página

El 13 de junio de 2026 se revisaron visualmente 26 archivos descargados desde TikTok (`Download.mp4` a `Download-26.mp4`). La página pública ahora organiza los enlaces en arcos narrativos, no sólo en orden cronológico.

La relación entre archivo descargado y enlace público se hizo por el orden visual de publicación y por los identificadores de TikTok. Hay una limitación: llegaron 26 archivos, pero en el texto de enlaces hubo un vínculo repetido/mal formado. Por eso una pieza quedó marcada como pendiente de confirmar enlace único:

- Pendiente: "Buscamos el templo afuera".

También quedó marcada una pieza para revisar técnicamente:

- Revisar: "El guardián de mi hermano"; el archivo descargado tenía una cola negra larga desde aproximadamente 1:31.

Arcos publicados en la web:

1. El mundo original.
2. El cielo roto.
3. Lenguaje, símbolos y templos.
4. Los antiguos sobrevivientes.
5. El mundo que inventamos.
6. La Tierra y el dolor.
7. Piezas por confirmar.
